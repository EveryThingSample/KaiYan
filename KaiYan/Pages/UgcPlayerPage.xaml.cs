...
namespace KaiYan.Pages
{
    ...
    public sealed partial class UgcPlayerPage : Page, ISwipeControlItem
    {
        ...
        private void MyImage_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            {
                if (e.NewSize.Width / flipView.ActualWidth > e.NewSize.Height / flipView.ActualHeight)
                {
                    MyScrollViewer.ChangeView(null, null, (float)(flipView.ActualWidth / image.ActualWidth - 0.0000005f), true);
                }
                else
                {
                    MyScrollViewer.ChangeView(null, null, (float)(flipView.ActualHeight / image.ActualHeight - 0.0000005f), true);
                }
            }
        }
        ...
        private void videoPlayerConcrol_IsFullWindowChanged(object sender, bool e)
        {
            InfoGrid.Visibility = e ? Visibility.Collapsed : Visibility.Visible;
        }
    }
}
